...
exports.Util = exports.HashMap = exports.TeRandom = exports.MapList = exports.TeMap = void 0;
...
class TeRandom {
    ...
    reset(seed) {
        this._seed = seed % TeRandom.MX_Base;
    }
    get seed() {
        return this._seed;
    }
    random(min, max, msg = "") {
        ...
        this._seed = (this._seed * 9301 + 49297) % TeRandom.MX_Base;
        var rnd = this._seed / parseFloat(TeRandom.MX_Base.toString());
